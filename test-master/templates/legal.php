...
<p>iStudy Platform ("us", "we", or "our") operates the inventxr.com website (the "Service").</p>

<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. This Privacy Policy  for iStudy Platform is powered by <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">FreePrivacyPolicy.com</a>.</p>

<p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from inventxr.com</p>
...
<p>iStudy Platform uses the collected data for various purposes:</p>
<ul>
...
<p>iStudy Platform may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of iStudy Platform</li>
...
<p>Our Service does address people under the age of 18 ("Children").</p>
<p>We do knowingly collect personally identifiable information from people under the age of 18. It is the parent's responsability to verify their "children" activity on system. If you are a parent and do not consent your "children" using our service, you can email us at arturbarbosa10@gmail.com and we will immediately remove any Personal Data that your "children" entered in our system.</p>


<h2>Changes To This Privacy Policy</h2>
<p>We may update our Privacy Policy from time to time. We will notify you (if you are a registered member) of any changes by posting the new Privacy Policy on this page.</p>
...
<ul>
        <li>By email: arturbarbosa10@gmail.com</li>
...
<br><hr>
  ...
  <p>The iStudy website located at invenxr.com is a copyrighted work belonging to iStudy Platform. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>

  <p>All such additional terms, guidelines, and rules are incorporated by reference into these Terms.</p>

  <p>These Terms of Use described the legally binding terms and conditions that oversee your use of the Site. BY LOGGING INTO THE SITE, YOU ARE BEING COMPLIANT THAT THESE TERMS and you represent that you have the authority and capacity to enter into these Terms. IF YOU ARE UNDER 18, YOU MUST ASK YOUR PARENTS TO ACCESS OUR SERVICE AND SHARE YOUR PERSONAL INFORMATION. IF YOU DISAGREE WITH ALL OF THE PROVISION OF THESE TERMS, DO NOT LOG INTO AND/OR USE THE SITE.<p>
  ...
  <p><strong>Cookies and Web Beacons.</strong> Like any other website, iStudy uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.</p>
  ...
  <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Brazil. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
